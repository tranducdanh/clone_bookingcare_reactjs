        ...
        return (
            <div className='doctor-extra-infor-container'>
                ...
                <div className='content-down'>
                    {isShowDetailInfor === false && 
                    <div>
                        <span 'text'>GIÁ KHÁM:</span> {extraInfor && extraInfor.priceTypeData?extraInfor.priceTypeData.valueVi:''}đ. <span className='show' onClick={()=>{this.showHideDetailInfor(true)}}>Xem chi tiết</span>
                    </div>}
