...
class ProfileDoctor extends Component {
    ...
    renderTimeBooking = (dataScheduleTimeModal)=>{
        ...
        if(dataScheduleTimeModal && !_.isEmpty(dataScheduleTimeModal)){
            let date = language ===LANGUAGES.VI? moment(new Date(dataScheduleTimeModal.date)).format('DD/MM/YYYY'):
            moment(new Date(dataScheduleTimeModal.date)).format('MM/MM/YYYY')
            return(
                <>
