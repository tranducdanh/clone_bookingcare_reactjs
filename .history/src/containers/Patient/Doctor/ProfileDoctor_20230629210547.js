    ...
    render() {
        ...
        return (
            ...
            <div className='price-modal'>
                {dataProfile && dataProfile.Doctor_Infor && language ===LANGUAGES.VI ? dataProfile.Doctor_Infor.priceTypeData.valueVi:''}
                {dataProfile && dataProfile.Doctor_Infor && language ===LANGUAGES.EN ? dataProfile.Doctor_Infor.priceTypeData.valueEn:''}
            </div>
            </>
