        ...
        if (dataScheduleTimeModal && !_.isEmpty(dataScheduleTimeModal)) {
            ...
            return (
                <>
                    ...
                    <div>
                        <FormattedMessage id='home-page.free' />
                    </div>
                </>
            );
        }
        ...
        return (
            <>
                ...
                {isShowLinkDetail === true && (
                    <div className='link-view-detail-doctor'>
                        <Link
                            href={`/detail-doctor/${doctorId}`}
                            className='link-view'
                        >
                            <FormattedMessage id='home-page.specialty.more-specialty' />
                        </Li>
                    </div>
                )}
                {isShowPrice === true && (
                    <div className='price-modal'>
                        <span className='text-price-modal'>
