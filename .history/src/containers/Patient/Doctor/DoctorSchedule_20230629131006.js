    ...
    render() {
        ...
        return (
            <>
                ...
                <div className='all-time-available'>
                    ...
                    <div className='time-available-content'>
                        {allAvailableTime && allAvailableTime.length > 0 ? allAvailableTime.map((item, index)=>{
                            ...
                            return(
                                <button onClick={()=>{this.handleClickScheduleTime(item)}} key={index} className='btn-available-time'>{timeDisplay}</button>
                            )
                ...
                <BookingModal isOpenModalBooking={isOpenModalBooking} closeBookingModal/>
            </>
