        ...
        return (
            <div className='doctor-extra-infor-container'>
                ...
                <div className='content-down'>
                    {isShowDetailInfor === false && 
                    <div>
                        GIÁ KHÁM: 300.000đ. <span className='show-hide' onClick={()=>{this.showHideDetailInfor(true)}}>Xem chi tiết</span>
                    </div>}
                    ...
                    <span className='show-hide' onClick={()=>{this.showHideDetailInfor(false)}}>Ẩn bảng giá</span>
                    </>
                    }
                </div>
            </div>
