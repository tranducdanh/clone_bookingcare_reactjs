...
class ProfileDoctor extends Component {
    ...
    renderTimeBooking = (dataScheduleTimeModal)=>{
        ...
        if(dataScheduleTimeModal && !_.isEmpty(dataScheduleTimeModal)){
            let date = language ===LANGUAGES.VI? moment(new Date(dataScheduleTimeModal.date)).format('dddd - DD/MM/YYYY'):
            moment(new Date(dataScheduleTimeModal.date)).format('ddd - MM/DD/YYYY')
            return(
                <>
                <div>14:45 - 15:00 - Thứ 6 - 30/06/2023</div>
