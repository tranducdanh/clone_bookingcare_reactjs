                    ...
                    <div className='doctor-schedule-main'>
                        <div className='doctor-schedule'>
                            <div className='content-left'>
                                <DoctorSchedule detailDoctor={detailDoctor && detailDoctor.id? detailDoctor.id: -1}/>
                            </div>
                            <div className='content-right'>
                                <div>
                                    ĐỊA CHỈ KHÁM <br/>
                                    Phòng khám Chuyên khoa Da Liễu <br/>
                                    207 Phố Huế - Hai Bà Trưng - Hà Nội                                
                                
                                </div>
                                <div className='price'>GIÁ KHÁM: 300.000<sup>đ</sup>. <a href="#">Xem chi tiết</a> </div>
                                <div className='health-insurance'>LOẠI BẢO HIỂM ÁP DỤNG. <a href="#">Xem chi tiết</a></div>
                            </div>
                        </div>
                    </div>
