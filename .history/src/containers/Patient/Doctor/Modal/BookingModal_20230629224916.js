                    ...
                    <div className='booking-modal-content'>
                        ...
                        <div className='booking-modal-body'>
                            ...
                            <div className='doctor-infor-modal'>
                                <ProfileDoctor doctorId={doctorId} isShowDescriptionDoctor={false} dataScheduleTimeModal={dataScheduleTimeModal}/>
                            </div>
                            
                            <div className='row'>
                                <div className='col-6 form-group'>
                                    <label><FormattedMessage id='home-page.name'/></label>
                                    <input type="text" className='form-control' />
                                </div>
                                <div className='col-6 form-group'>
                                    <label><FormattedMessage id='home-page.phonenumber'/></label>
                                    <input type="text" className='form-control' />
                                </div>
                                <div className='col-6 form-group'>
                                    <label><FormattedMessage id='home-page.email'/></label>
                                    <input type="text" className='form-control' />
                                </div>
                                <div className='col-6 form-group'>
