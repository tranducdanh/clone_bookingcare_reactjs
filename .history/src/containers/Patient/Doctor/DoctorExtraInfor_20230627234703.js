        ...
        return (
            <div className='doctor-extra-infor-container'>
                ...
                <div className='content-down'>
                    {isShowDetailInfor === false && 
                    <div>
                        <span className='text'>GIÁ KHÁM:</span> {extraInfor && extraInfor.priceTypeData&& language===LANGUAGES.VI&&extraInfor.priceTypeData.valueVi&&<sup>đ</sup>}{extraInfor && extraInfor.priceTypeData&& language===LANGUAGES.VI&&extraInfor.priceTypeData.valueVi&&<sup>đ</sup>}. <span className='show' onClick={()=>{this.showHideDetailInfor(true)}}>Xem chi tiết</span>
                    </div>}
