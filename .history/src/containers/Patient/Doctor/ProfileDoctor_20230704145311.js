...
class ProfileDoctor extends Component {
    ...
    render() {
        let { language, isShowDescriptionDoctor, dataScheduleTimeModal, isShowLinkDetail, isShowPrice, doctod } = this.props;
        ...
        return (
            <>
                ...
                {isShowLinkDetail === true &&
                    <div className='link-view-detail-doctor'><a href={`/detail-doctor/20`} className='link-view'><FormattedMessage id='home-page.specialty.more-specialty'/></a></div>
                }
                {isShowPrice === true &&
