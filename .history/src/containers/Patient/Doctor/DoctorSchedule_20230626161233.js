                ...
                <div className='all-time-available'>
                    ...
                    <div className='time-available-content'>
                        {allAvailableTime && allAvailableTime.length > 0 && allAvailableTime.map((item, index)=>{
                            let timeDisplay = language === LANGUAGES.VI ? item.timeTypeData.valueVi: item.timeTypeData.valueVi
                            return(
                                <button key={index} className='btn-available-time'>{item.timeType}</button>
                            )
                        })}                      
