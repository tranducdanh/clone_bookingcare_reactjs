            ...
            <div className='section-share section-handbook'>
                <div className='section-container'>
                    <div className='section-header'>
                        <span className='title-section'><FormattedMessage id='home-page.handbook.title-handbook'/></span>
                        <button className='btn-section'><FormattedMessage id='home-page.handbook.title-handbook'/></button>
                    </div>
