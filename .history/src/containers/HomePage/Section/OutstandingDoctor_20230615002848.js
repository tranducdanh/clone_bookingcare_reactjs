                    ...
                    <div className='section-body'>
                        <Slider {...this.props.settings}>
                            <div className='section-custom section-outstanding-doctor'>
                                ...
                                <div className='sub'>Cơ Xương Khớp 1</div>
                                </div>
                                </div>
                            </div>
                            <div className='section-custom section-outstanding-doctor'>
                            <div className='space'>
                                ...
                                <div className='sub'>Cơ Xương Khớp 2</div>
                                </div>
                                </div>
                            </div>
                            <div className='section-custom section-outstanding-doctor'>
                            <div className='space'>
                                ...
                                <div className='sub'>Cơ Xương Khớp 3</div>
                                </div>
                                </div>
                            </div>
                            <div className='section-custom section-outstanding-doctor'>
                            <div className='space'>
                                ...
                                <div className='sub'>Cơ Xương Khớp 4</div>
                                </div>
                                </div>
                            </div>
                            <div className='section-custom section-outstanding-doctor'>
                            <div className='space'>
                                ...
                                <div className='sub'>Cơ Xương Khớp 5</div>
                                </div>
                                </div>
                            </div>
                            <div className='section-custom section-outstanding-doctor'>
                            <div className='space'>
                                ...
                                <div className='sub'>Cơ Xương Khớp 6</div>
                                </div>
                                </div>
                            </div>
                            <div className='section-custom section-outstanding-doctor'>
                            <div className='space'>
                                ...
                                <div className='sub'>Cơ Xương Khớp 7</div>
                                </div>
                                </div>
                            </div>
                            <div className='section-custom section-outstanding-doctor'>
                            <div className='space'>
                                ...
                                <div className='sub'>Cơ Xương Khớp 8</div>
                                </div>
                                </div>
                            </div>
                        </Slider>
