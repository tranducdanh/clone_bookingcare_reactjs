                ...
                <div className='manage-patient-container'>
                    ...
                    <div className='manage-patient-content row'>
                        <div className='col-5 form-group'>
                            <label>
                                <FormattedMessage id='menu.manage-patient.select-date' />
                            </label>
                            <DatePicker
                        ...
                        <div className='col-12 table-manage-patient'>
                            <table>
                                <tr>
                                    <th>
                                        <FormattedMessage id='menu.manage-patient.num' />
                                    </th>
                                    <th>
                                        <FormattedMessage id='menu.manage-patient.name' />
                                    </th>
                                    <th>
                                        <FormattedMessage id='menu.manage-patient.address' />
                                    </th>
                                    <th>
                                        <FormattedMessage id='menu.manage-patient.gender' />
                                    </th>
                                    <th>
                                        <FormattedMessage id='menu.manage-patient.time' />
                                    </th>
                                    <th>Actions</th>
                                </tr>
                                        ...
                                        return (
                                            <tr key={index}>
                                                ...
                                                <td>
                                                    ...
                                                    >
                                                        <FormattedMessage id='menu.manage-patient.confirm' />
                                                    </button>
                                                </td>
                                            </tr>
                                        );
