                            ...
                            {dataPatient && dataPatient.length > 0 ? dataPatient.map((item, index) => {
                                return(
                                    <tr key={index}>
                                        ...
                                        <td>
                                            <button onClick={()=>{this.handleBtnConfirm()}} className='btn btn-warning'><FormattedMessage id='menu.manage-patient.confirm' /></button>
                                            <button onClick={()=>{this.hanleBtnRedemy()}} className='btn btn-info'><FormattedMessage id='menu.manage-patient.send-bill' /></button>
                                        </td>
                                    </tr>
                                )
                            })
