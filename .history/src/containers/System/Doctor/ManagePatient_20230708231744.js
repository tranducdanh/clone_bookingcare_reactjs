                            ...
                            {dataPatient && dataPatient.length > 0 ? dataPatient.map((item, index) => {
                                return(
                                    <tr key={index}>
                                        ...
                                        <td>{language === LANGUAGES.VI? item.patientData.genderData.valueVi :  item.patientData.genderData.valueVi}</td>
                                        <td>{item.timeTypeDataPatient.valueVi}</td>
                                        <td>
                                            <button className='btn btn-warning'><FormattedMessage id='menu.manage-patient.confirm' /></button>
                                            <button className='btn btn-info'><FormattedMessage id='menu.manage-patient.send-bill' /></button>
                                        </td>
                                    </tr>
                                )
                            })
