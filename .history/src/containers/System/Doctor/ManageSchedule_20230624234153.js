                    ...
                    <div className='row'>
                        ...
                        <div className='col-12 choose-hour-container'>
                            ...
                            rangeTime.map((item, index)=>{
                                return(
                                    <button onClick={()=>{this.handleOnClickBtnTime(item)}} className={item.isSelected === true?'btn-time active':} key={index}>{language===LANGUAGES.VI?item.valueVi:item.valueEn}</button>
                                )
                            })}
                        </div>
