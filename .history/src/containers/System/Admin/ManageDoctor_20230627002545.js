...
class ManageDoctor extends Component {
    ...
    componentDidUpdate(prevProps, prevState, snapshot) {
        ...
        if(prevProps.allRequiredDoctorInfor !== this.props.allRequiredDoctorInfor){
            // console.log('check data required doctor infor: ', this.props.allRequiredDoctorInfor);
            let dataSelectPrice = this.buildDataInputSelect(this.props.allDoctors);
            let dataSelectPayment = this.buildDataInputSelect(this.props.allDoctors);
            let dataSelectProvince = this.buildDataInputSelect(this.props.allDoctors);
            this.setState({
